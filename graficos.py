...
if zone is None or zone == "Argentina":
    ...
    data_file = Path(__file__).parent / "time-series_data" / "Time series of Vegetation loss • Annual by class • 1985 - 2024 (Argentina).csv"
    ...
    data_file = Path(__file__).parent / "time-series_data" / filename
    data = load_data(data_file)
